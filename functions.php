...
function get_ships()
{
    ...
    $ship2 = new Ship('ClockShape Fighter');

    $ship2->setWeaponPower(4);
    $ship2->setJediFactor(12);
    $ship2->setStrenght(10);
    $ships['clockshape_fighter'] = $ship2;
    ...
    $ships['super_star_destoryer'] = $ship3;

    $ship4 = new Ship('RZ-1 A-wing interceptor');
    $ship4->setWeaponPower(1);
    $ship4->setJediFactor(4);
    $ship4->setStrenght(15);
